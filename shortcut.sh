...
# Modify below line to open window maximized instead of fullscreen
echo "Exec=chromium-browser --start-maximized http://127.0.0.1:5001/webui" >> /home/bitk1/Desktop/BKAD-IPFS.desktop
