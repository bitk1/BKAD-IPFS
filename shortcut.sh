...
# Add a delay and then open Chromium in fullscreen
echo "Exec=bash -c 'sleep 2; chromium-browser --start-fullscreen http://127.0.0.1:5001/webui'" >> /home/bitk1/Desktop/BKAD-IPFS.desktop
